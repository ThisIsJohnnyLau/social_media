...
twts_foodie <- read_twitter_csv(here("raw_data/twts_foodie_23112020.csv"))
# names(twts_foodie)
```

```{r}
ts_plot(twts_foodie, by = "hours", color = "blue")
```
...
custom_stopwds <- c("amp", "ve", "don", "lo", "foodie", "food", "change", "de")
...
sa.value <- get_nrc_sentiment(twts_foodie$text)
...
#users
user_cos <- users_data(twts_foodie) %>%
