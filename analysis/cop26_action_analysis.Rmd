...
twts_COP26Action <- read_twitter_csv(here("raw_data/twts_COP26Action_18112020.csv"))

```

```{r}
ts_plot(twts_COP26Action, by = "hours", color = "blue")
```
...
sa.value <- get_nrc_sentiment(twts_COP26Action$text)
...
rply_df <- twts_COP26Action[, c("screen_name" , "reply_to_screen_name" )]
...
cc_coord <- lat_lng(twts_COP26Action)
